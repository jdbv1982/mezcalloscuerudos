...
<head>
    ...
    <Meta Name="Keywords" Content="mezcal, mezcal oaxaca, licores oaxaca,mezcal los cuerudos, mezcales, el mejor mezcal, los cuerudos oaxaca">
    <link rel="icon" href="../../favicon.ico">
    <title>Mezcal los Cuerudos</title>
    @include('layouts/css')
    @yield('css')
</head>
